 ...
 * @class
 * @hideconstructor
 * @classdesc The module that handles all user interactions, exposes one variable: isDown (used by C.Collection to determine when to quit animation loop)
 * @extends C
 * @name touch
 */
C.touch = (function () {
